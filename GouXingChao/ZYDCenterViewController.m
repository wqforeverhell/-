...
@interface ZYDCenterViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateWaterfallLayout>
{
...
@implementation ZYDCenterViewController
...
- (void)viewDidLoad
{
    ...
    __weak ZYDCenterViewController *viewController = self;
...
//    [ZYEngine getDCenterTextMessage:currentIndex        :^(NSMutableArray *array) {
//        if (currentIndex == 0) {
...
//    }];
    ...
    [ZYEngine getDLeftTextMessage:currentIndex withType:2 :^(NSMutableArray *array) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.placeButton setImageWithURL:[NSURL URLWithString:list.focusHeadImgUrl]];
