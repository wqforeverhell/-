...
- (void)viewDidLoad
{
    ...
    NSArray*titleArray=[NSArray arrayWithObjects:@"推荐",@"最新",@"销量",@"价格", nil];
    ...
    [self requestDetail];
    __weak SearchViewController *viewController = self;
...
-(void)requestDetail
{
    ...
    NSArray*array=[NSArray arrayWithObjects:@"default",@"new", @"sales",@"priceUp",nil];
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObject:@"text/html"];
    NSString*orderType=[array objectAtIndex:segSelectNum];
    
    NSString *url = [NSString stringWithFormat:@"http://service1.taotaosou.com/appTextSearch.do?keyword=%@&orderType=%@&page=%d&userId=7206958",[self.keyWord stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding],orderType,currentIndex];
